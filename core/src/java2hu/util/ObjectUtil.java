...
public class ObjectUtil extends J2hObject
{
	public static void deathAnimation(final StageObject obj)
	{
		...
		{
			final float xPos = obj.getX() + circles[i];
			final float yPos = obj.getY() + circles[i + 1];
